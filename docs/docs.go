    ...
    "paths": {
        ...
        "/strict/bisnis_matching/{id}": {
            "put": {
                ...
                "operationId": "bisnis_matching-update",
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
                        "description": "Id produk untuk update data bisnis matching",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "Status untuk update data bisnis matching",
                        "name": "status",
                        "in": "query",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/bumd.BumdModel"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/strict/bumd/kelengkapan_input": {
            "get": {
                ...
                "operationId": "kelengkapan_input-view",
                "parameters": [
                    {
                        "type": "string",
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/bumd.KelengkapanInputModel"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/strict/bumd/{id_bumd}/akta_notaris": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dokumen.AktaNotarisModel"
                        }
                    },
                    "400": {
                        "description": "Bad request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Tanggal Akta notaris",
                        "name": "tanggal",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/strict/bumd/{id_bumd}/akta_notaris/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dokumen.NibModel"
                            }
                        }
                    },
                    "400": {
        ...
        "/strict/bumd/{id_bumd}/pengurus": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Jabatan Struktur",
                        "name": "jabatan_struktur",
                        "in": "formData",
                        "required": true
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Tanggal Mulai Jabatan",
                    ...
                    {
                        "type": "string",
                        "description": "Tanggal Akhir Jabatan",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "number",
                        "format": "float64",
                        "description": "Modal Dasar Min",
                        "name": "modal_dasar_min",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "format": "float64",
                        "description": "Modal Dasar Max",
                        "name": "modal_dasar_max",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dokumen.PerdaPendirianModel"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/strict/bumd/{id_bumd}/perda_pendirian/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Id untuk get data perda pendirian",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dokumen.SiupModel"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dokumen.TdpModel"
                            }
                        }
                    },
                    "400": {
