...
type RKAModel struct {
	...
	Klasifikasi     string     `json:"klasifikasi" xml:"klasifikasi" example:"RKA"`
...
type RKAForm struct {
	...
	Klasifikasi     string                `json:"klasifikasi" xml:"klasifikasi" form:"klasifikasi" validate:"required" example:"RKA"`
	...
	File            *multipart.FileHeader `json:"file" xml:"file" form:"file" example:"/path/to/file.pdf"`
