...
type PeraturanForm struct {
	...
	JenisPeraturan      uuid.UUID             `json:"jenis_peraturan" xml:"jenis_peraturan" form:"jenis_peraturan" validate:"required,custom_uuid" example:"01994c04-699d-75e0-a288-13980f8c854d"`
}
