...
type PeraturanModel struct {
	...
	JenisPeraturan      uuid.UUID  `json:"jenis_peraturan" xml:"jenis_peraturan"`
...
type PeraturanForm struct {
	...
	JenisPeraturan      uuid.UUID             `json:"jenis_peraturan" xml:"jenis_peraturan" form:"jenis_peraturan"`
}
