...
type DomisiliModel struct {
	...
	Klasifikasi     string     `json:"klasifikasi" xml:"klasifikasi" example:"Domisili"`
...
type DomisiliForm struct {
	...
	Klasifikasi     string                `json:"klasifikasi" xml:"klasifikasi" form:"klasifikasi" example:"Domisili"`
