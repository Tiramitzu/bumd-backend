...
type SiupModel struct {
	...
	Klasifikasi     string     `json:"klasifikasi" xml:"klasifikasi" example:"SIUP"`
...
type SiupForm struct {
	...
	Klasifikasi     string                `json:"klasifikasi" xml:"klasifikasi" form:"klasifikasi" example:"SIUP"`
