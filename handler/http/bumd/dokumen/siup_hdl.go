...
type SiupHandler struct {
	Controller *ctl.SiupController
	Validate   *validator.Validate
}

func NewSiupHandler(r fiber.Router, validator *validator.Validate, controller *ctl.SiupController) {
	handler := &SiupHandler{
		Controller: controller,
		Validate:   validator,
	}

	rStrict := r.Group("siup")
...
// Index func for get data siup.
//
//	@Summary		get data siup
//	@Description	get data siup.
//	@ID				siup-index
//	@Tags			Siup
//	@Produce		json
...
//	@Success		200				{object}	[]dokumen.SiupModel	"Success"
//	@Failure		400				{object}	utils.RequestError	"Bad request"
//	@Failure		404				{object}	utils.RequestError	"Data not found"
//	@Failure		422				{array}		utils.RequestError	"Data validation failed"
//	@Failure		500				{object}	utils.RequestError	"Server error"
//	@Security		ApiKeyAuth
//	@Router			/strict/bumd/{id_bumd}/siup [get]
func (h *SiupHandler) Index(c *fiber.Ctx) error {
...
//	@Produce		json
//	@Param			id_bumd	path		int					true	"Id BUMD"
//	@Param			id		path		int					true	"Id SIUP"
//	@Success		200		{object}	dokumen.SiupModel	"Success"
//	@Failure		400		{object}	utils.RequestError	"Bad request"
//	@Failure		404		{object}	utils.RequestError	"Data not found"
//	@Failure		422		{array}		utils.RequestError	"Data validation failed"
//	@Failure		500		{object}	utils.RequestError	"Server error"
//	@Security		ApiKeyAuth
//	@Router			/strict/bumd/{id_bumd}/siup/{id} [get]
func (h *SiupHandler) View(c *fiber.Ctx) error {
	idBumd, err := c.ParamsInt("id_bumd")
	if err != nil {
		return err
	}
...
// Create func for create data siup.
//
//	@Summary		create data siup
//	@Description	create data siup.
//	@ID				siup-create
//	@Tags			Siup
...
//	@Failure		500					{object}	utils.RequestError	"Server error"
//	@Security		ApiKeyAuth
//	@Router			/strict/bumd/{id_bumd}/siup [post]
func (h *SiupHandler) Create(c *fiber.Ctx) error {
	idBumd, err := c.ParamsInt("id_bumd")
	if err != nil {
		return err
	}
	payload := new(dokumen.SiupForm)
...
// Update func for update data siup.
//
//	@Summary		update data siup
//	@Description	update data siup.
//	@ID				siup-update
//	@Tags			Siup
//	@Accept			multipart/form-data
//	@Param			id_bumd				path		int					true	"Id BUMD"
//	@Param			id					formData	int					true	"Id SIUP"
...
//	@Failure		500					{object}	utils.RequestError	"Server error"
//	@Security		ApiKeyAuth
//	@Router			/strict/bumd/{id_bumd}/siup/{id} [put]
func (h *SiupHandler) Update(c *fiber.Ctx) error {
	idBumd, err := c.ParamsInt("id_bumd")
	if err != nil {
		return err
	}
...
// Delete func for delete data siup.
//
//	@Summary		delete data siup
//	@Description	delete data siup.
//	@ID				siup-delete
//	@Tags			Siup
//	@Accept			json
//	@Param			id_bumd	path		int					true	"Id BUMD"
...
//	@Failure		500		{object}	utils.RequestError	"Server error"
//	@Security		ApiKeyAuth
//	@Router			/strict/bumd/{id_bumd}/siup/{id} [delete]
func (h *SiupHandler) Delete(c *fiber.Ctx) error {
	idBumd, err := c.ParamsInt("id_bumd")
	if err != nil {
		return err
	}
